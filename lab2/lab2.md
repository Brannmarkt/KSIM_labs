...
Оновлено процедури ask sheep/wolf, до них додано виклик нових процедур, що описують рух тварин.
...
В якості власного нововведення було додано процедуру для реалізації збиття вовків у зграї. Процедура перевіряє оточення на наявність інших вовків, обраховує середній напярмок руху вовків, з урахуванням якого корегує напрямок руху тварини.
...
Фінальний код моделі доступний за [посиланням](https://www.netlogoweb.org/launch#https://www.netlogoweb.org/assets/modelslib/Sample%20Models/Biology/Wolf%20Sheep%20Predation.nlogox). 
